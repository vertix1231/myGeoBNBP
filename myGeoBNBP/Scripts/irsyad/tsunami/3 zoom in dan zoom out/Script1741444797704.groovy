...
WebUI.takeScreenshot(('C://Users//USER//Desktop//braga bnbp//evidence//' + GlobalVariable.tsunami) + '//zoominout1.jpg')

WebUI.click(findTestObject('Object Repository/irsyad/tsunami/button_Tsunami Hazard Information'))

Thread.sleep(1000)

WebUI.takeScreenshot(('C://Users//USER//Desktop//braga bnbp//evidence//' + GlobalVariable.hazard) + '//zoominout2.jpg')
...
WebUI.takeScreenshot(('C://Users//USER//Desktop//braga bnbp//evidence//' + GlobalVariable.hazard) + '//zoominout3.jpg')

WebUI.click(findTestObject('Object Repository/irsyad/tsunami/button_Sign In'))

Thread.sleep(1000)

WebUI.takeScreenshot(('C://Users//USER//Desktop//braga bnbp//evidence//' + GlobalVariable.hazard) + '//zoominout4.jpg')

WebUI.click(findTestObject('Object Repository/irsyad/tsunami/button_Back'))

Thread.sleep(1000)

WebUI.takeScreenshot(('C://Users//USER//Desktop//braga bnbp//evidence//' + GlobalVariable.hazard) + '//zoominout5.jpg')

WebUI.click(findTestObject('Object Repository/irsyad/tsunami/button_More Detail_bg-transparent hoverbg-g_3acdfd'))

Thread.sleep(1000)

WebUI.takeScreenshot(('C://Users//USER//Desktop//braga bnbp//evidence//' + GlobalVariable.hazard) + '//zoominout6.jpg')

WebUI.click(findTestObject('Object Repository/irsyad/tsunami/button_More Detail_bg-transparent hoverbg-g_3acdfd_1'))

Thread.sleep(1000)

WebUI.takeScreenshot(('C://Users//USER//Desktop//braga bnbp//evidence//' + GlobalVariable.hazard) + '//zoominout7.jpg')
