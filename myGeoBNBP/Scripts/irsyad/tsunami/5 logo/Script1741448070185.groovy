...
WebUI.takeScreenshot(('C://Users//USER//Desktop//braga bnbp//evidence//' + GlobalVariable.tsunami) + '//peta_mhews1.jpg')

WebUI.click(findTestObject('Object Repository/irsyad/tsunami/button_Tsunami Hazard Information'))

Thread.sleep(1000)

WebUI.takeScreenshot(('C://Users//USER//Desktop//braga bnbp//evidence//' + GlobalVariable.hazard) + '//peta_mhews2.jpg')
...
WebUI.takeScreenshot(('C://Users//USER//Desktop//braga bnbp//evidence//' + GlobalVariable.hazard) + '//peta_mhews3.jpg')

WebUI.click(findTestObject('Object Repository/irsyad/tsunami/button_Sign In'))

Thread.sleep(1000)

WebUI.takeScreenshot(('C://Users//USER//Desktop//braga bnbp//evidence//' + GlobalVariable.hazard) + '//peta_mhews4.jpg')

WebUI.click(findTestObject('Object Repository/irsyad/tsunami/button_Back'))

Thread.sleep(1000)

WebUI.takeScreenshot(('C://Users//USER//Desktop//braga bnbp//evidence//' + GlobalVariable.hazard) + '//peta_mhews5.jpg')

WebUI.click(findTestObject('Object Repository/irsyad/tsunami/button_More Detail_bg-transparent hoverbg-g_3acdfd'))

Thread.sleep(1000)

WebUI.takeScreenshot(('C://Users//USER//Desktop//braga bnbp//evidence//' + GlobalVariable.hazard) + '//peta_mhews6.jpg')

WebUI.click(findTestObject('Object Repository/irsyad/tsunami/button_More Detail_bg-transparent hoverbg-g_3acdfd_1'))

Thread.sleep(1000)

WebUI.takeScreenshot(('C://Users//USER//Desktop//braga bnbp//evidence//' + GlobalVariable.hazard) + '//peta_mhews7.jpg')

WebUI.click(findTestObject('Object Repository/irsyad/tsunami/img_MHEWS Map_h-9 max-w-32 smmax-w-56 objec_e7bcc4'))

Thread.sleep(1000)

WebUI.takeScreenshot(('C://Users//USER//Desktop//braga bnbp//evidence//' + GlobalVariable.hazard) + '//peta_mhews8.jpg')
