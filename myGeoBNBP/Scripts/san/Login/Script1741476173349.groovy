...
WebUI.takeScreenshot(('/Users/fabhiantom/Downloads/myGeoBNBP/evidence/' + GlobalVariable.hazard) + '/hazard5.jpg')

WebUI.click(findTestObject('Object Repository/San/MH/button_Sign In'))

Thread.sleep(10000)

WebUI.takeScreenshot(('/Users/fabhiantom/Downloads/myGeoBNBP/evidence/' + GlobalVariable.hazard) + '/hazard6.jpg')
