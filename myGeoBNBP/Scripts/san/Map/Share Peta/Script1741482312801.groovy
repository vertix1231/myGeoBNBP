...
WebUI.click(findTestObject('Object Repository/San/MH/button_Share Map'))

//Thread.sleep(5000)

WebUI.takeScreenshot(('/Users/fabhiantom/Downloads/myGeoBNBP/evidence/' + GlobalVariable.hazard) + '/share1.jpg')
