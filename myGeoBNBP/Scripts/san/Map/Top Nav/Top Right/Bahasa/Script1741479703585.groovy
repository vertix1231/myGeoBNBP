...
WebUI.takeScreenshot(('/Users/fabhiantom/Downloads/myGeoBNBP/evidence/' + GlobalVariable.hazard) + '/bhs0.jpg')

WebUI.click(findTestObject('Object Repository/San/MH/svg_Share Map_nuxt-icon--fill w-5 h-5 text-_9e9795'))

WebUI.takeScreenshot(('/Users/fabhiantom/Downloads/myGeoBNBP/evidence/' + GlobalVariable.hazard) + '/bhs1.jpg')

WebUI.click(findTestObject('Object Repository/San/MH/li_Indonesia'))

Thread.sleep(10000)

WebUI.takeScreenshot(('/Users/fabhiantom/Downloads/myGeoBNBP/evidence/' + GlobalVariable.hazard) + '/bhs2.jpg')
