...
WebUI.click(findTestObject('Object Repository/San/MH/div_Share Map_cursor-pointer border border-_2abaa6'))

WebUI.takeScreenshot(('/Users/fabhiantom/Downloads/myGeoBNBP/evidence/' + GlobalVariable.hazard) + '/notif1.jpg')

WebUI.click(findTestObject('Object Repository/San/MH/div_1 Days AgoWarning Tsunami PD-4Warning T_df214e'))

WebUI.takeScreenshot(('/Users/fabhiantom/Downloads/myGeoBNBP/evidence/' + GlobalVariable.hazard) + '/notif2.jpg')

//WebUI.click(findTestObject('Object Repository/San/MH/button_Back'))

//WebUI.takeScreenshot(('/Users/fabhiantom/Downloads/myGeoBNBP/evidence/' + GlobalVariable.hazard) + '/notif3.jpg')
