...
WebUI.click(findTestObject('Object Repository/San/MH/button_Share Map_focusoutline-none disabled_871cbe'))

WebUI.click(findTestObject('Object Repository/San/MH/button_Pengaturan Profil'))

WebUI.takeScreenshot(('/Users/fabhiantom/Downloads/myGeoBNBP/evidence/' + GlobalVariable.hazard) + '/pp1.jpg')
